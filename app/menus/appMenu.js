...
function getHelpMenu(Menus) {
  return {
    ...
    submenu: [
      {
        label: "Excel for Linux Documentation",
      ...
      },
      {
        ...
        click: () =>
          shell.openExternal("https://support.microsoft.com/excel"),
      },
      {
        label: "Github Project",
        click: () =>
          shell.openExternal(
            "https://github.com/your-username/excel-for-linux"
          ),
      },
      {
