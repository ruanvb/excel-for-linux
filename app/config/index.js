...
function getSystemConfigFilePath() {
  return "/etc/excel-for-linux/config.json";
}
...
function populateConfigObjectFromFile(configObject, configPath) {
  ...
  if (checkSystemConfigFileExistence()) {
    try {
      ...
      console.info(
        "System-wide config loaded from /etc/excel-for-linux/config.json"
      );
    } catch (e) {
      console.warn(
...
function extractYargConfig(configObject, appVersion) {
  ...
  const parsedConfig = yargsInstance
    ...
    .options({
      ...
      appIcon: {
        default: "",
        describe: "App icon to show in the tray",
        type: "string",
      },
      appIconType: {
        default: "default",
      ...
      awayOnSystemIdle: {
        default: false,
        describe: "Sets a visual indicator when system goes idle (not applicable to Excel)",
        type: "boolean",
      },
      chromeUserAgent: {
      ...
      enableIncomingCallToast: {
        default: false,
        describe: "Not used by Excel for Linux (Teams-specific feature)",
        type: "boolean",
      },
      followSystemTheme: {
        default: false,
      ...
      incomingCallCommand: {
        default: null,
        describe:
          'Not used by Excel for Linux (Teams-specific feature)',
        type: "string",
      },
      ...
      url: {
        default: "https://www.office.com/launch/excel",
        describe: "Microsoft Excel Online URL",
        type: "string",
      },
...
function argv(configPath, appVersion) {
  ...
  console.info("[Excel for Linux] Starting Excel Online wrapper");
