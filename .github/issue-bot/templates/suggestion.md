...
>
> - [Unable to log in, stuck on a blank screen after entering credentials](https://github.com/your-username/excel-for-linux/issues) — This appears similar because you described a blank screen after entering credentials. You could try clearing the Cache, Code Cache, and Local Storage directories at `~/.config/excel-for-linux/`.
>
> - [Blank Page at Login](https://github.com/your-username/excel-for-linux/issues) — This might be related since the issue mentions a blank page during login. You could try refreshing with Ctrl+R or clearing the Application Cache folder.
>
...
>    ```bash
>    ELECTRON_ENABLE_LOGGING=true excel-for-linux --logConfig='{"transports":{"console":{"level":"debug"}}}'
>    ```
...
> </details>
>
> > **Tip:** You might also find helpful information in our [GitHub Issues](https://github.com/your-username/excel-for-linux/issues).
>
> ---
>
